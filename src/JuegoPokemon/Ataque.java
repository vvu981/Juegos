...
public class Ataque {
	...
	public int probBajarVidaP;
	public int probBajarVidaR;
	public int PP;
	public String definicion;
	/*
	 * especie es para ver si hace dano o no
	 * 		0: No hace dano -> Sube defensa
	 * 		-1: No hace dano -> Sube ataque
	 * 		1: Hace dano
	 * 		2: No hace dano -> Sube velocidad
	 */
	public Ataque(String nombre, double poder, String tipo, int prioridad, double precision, double probCrit, double probabCambioEstado, String cambioEstado, int probBajarVidaP,
	 int probBajarVidaR,double probabCambioEstadistica, double probRetr, String tipoAtaque,  int cambAtFisicoP, int cambAtEspecialP,  int cambDefFisicaP, int cambDefEspecialP, int cambVelP,
			 int cambAtFisicoR, int cambAtEspecialR,  int cambDefFisicaR, int cambDefEspecialR, int cambVelR, int cambPrecisionP, int cambPrecisionR, int PP, String definicion) {
		super();
		this.nombre = nombre;
		this.Poder = poder;
		this.tipo = tipo;
		...
		this.probBajarVidaP = probBajarVidaP;
		this.probBajarVidaR = probBajarVidaR;
	...
	public Ataque(Ataque ataque) {
		...
		this.probBajarVidaP = ataque.probBajarVidaP;
		this.probBajarVidaR = ataque.probBajarVidaR;
		...
		this.definicion = ataque.definicion;
	}
	...
	public int getProbBajarVidaP() {
		return probBajarVidaP;
	}

	public void setProbBajarVidaP(int probBajarVidaP) {
		this.probBajarVidaP = probBajarVidaP;
	}

	public int getProbBajarVidaR() {
		return probBajarVidaR;
	}

	public void setProbBajarVidaR(int probBajarVidaR) {
		this.probBajarVidaR = probBajarVidaR;
	}
}