...
public class VentanaDiv extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (btnSumar == e.getSource()) {
			...
			String resultado = oper.Div(Double.parseDouble(txtNum1.getText()),
