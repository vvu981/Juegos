...
public class VentanaMult extends JFrame implements ActionListener{
	...
	public VentanaMult() {
		...
		btnSumar = new JButton("MULTIPLICAR");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (btnSumar == e.getSource()) {
			...
			double resultado = oper.Mult(Double.parseDouble(txtNum1.getText()),
